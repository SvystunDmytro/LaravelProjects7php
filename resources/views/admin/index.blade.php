...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-5">
                   <h2>Панель редактирования новостей на сайте</h2>
                </div>

                <div class="col-sm-5">
                    <table>
                        <td>
                            <a href="{{action('Admin\AdminController@index')}}" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Admin PaNeL</span></a>
                        </td>
                        <td>
                            <a href="{{action('NewsController@index')}}" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Новости на сайте</span></a>
                        </td>
                        <td>
                            <a href="{{action('Admin\NewsController@create')}}" class="btn btn-primary"><i class="material-icons">&#xE147;</i> <span>Add New News</span></a>
                        </td>
